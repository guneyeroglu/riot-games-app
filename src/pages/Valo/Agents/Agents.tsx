...
const Agents = () => {
  ...
  const { data, isLoading, isError, refetch } = useFetchData('valo-agents');
  ...
  return (
    <div className={styles.container}>
      <div className={styles.container__background} style={{ backgroundImage: `url(${background})` }}></div>
      <div className={styles.container__filter}>
        <div className={styles['container__filter--mid']}>
          <SearchBar find='agent' inputValue={inputValue} onSetInputValue={setInputValue} />
          <Filter data={data} inputValue={inputValue} filterValue={filterValue} onSetFilterValue={setFilterValue} />
        </div>
      </div>
